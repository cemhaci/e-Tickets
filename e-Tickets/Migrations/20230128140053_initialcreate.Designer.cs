...
namespace e_Tickets.Migrations
{
    ...
    [Migration("20230128140053_initialcreate")]
            ...
            modelBuilder.Entity("e_Tickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 2, 4, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7024),
                            MovieCategory = 1,
                            Name = "AROG",
                            Price = 45.0,
                            StartDate = new DateTime(2023, 1, 28, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(6940),
                        ...
                        new
                        {
                            ...
                            CinemaId = 3,
                            Description = "This is the Arog movie description",
                            EndDate = new DateTime(2023, 2, 1, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7031),
                            MovieCategory = 5,
                            Name = "PARİTES OF THE CERİBBEAN at World's End",
                            Price = 60.0,
                            StartDate = new DateTime(2023, 1, 28, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7031),
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            Description = "This is the Arog movie description",
                            EndDate = new DateTime(2023, 1, 31, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7033),
                            MovieCategory = 2,
                            Name = "ESARETİN BEDELİ",
                            Price = 60.0,
                            StartDate = new DateTime(2023, 1, 28, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7033),
                        ...
                        new
                        {
                            ...
                            CinemaId = 4,
                            Description = "This is the Arog movie description",
                            EndDate = new DateTime(2023, 2, 7, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7035),
                            MovieCategory = 2,
                            Name = "THE GREEN MİLE",
                            Price = 60.0,
                            StartDate = new DateTime(2023, 1, 28, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7035),
                        ...
                        new
                        {
                            ...
                            CinemaId = 2,
                            Description = "This is the Arog movie description",
                            EndDate = new DateTime(2023, 2, 7, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7037),
                            MovieCategory = 4,
                            Name = "THE LORD OF THE RİNGS The Return Of The King",
                            Price = 60.0,
                            StartDate = new DateTime(2023, 1, 28, 17, 0, 52, 740, DateTimeKind.Local).AddTicks(7037),
